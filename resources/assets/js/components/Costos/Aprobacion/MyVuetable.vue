  ...
  <div class="container-fluid">
    <div class="row col-12">
      <div class="col-sm-10 float-left">
        <filter-barcap></filter-barcap>
      </div>
      <div class="col-sm-2">
        <div class="form-group">
          <div class="mx-auto" v-if="processing == false">
            <button class="btn btn-primary float-right" v-if="processing == false" :disabled="btnHab" @click="aprobar">Aprobar</button>
          </div>
          <div v-else="processing == true">
              <i class="fa fa-spinner fa-spin float-right" style="font-size:20px"></i>
          </div>&nbsp;
        </div>
      </div>
    </div>
...
Vue.component('filter-barcap', FilterBar)
